...
<template>
  <div class="min-h-screen flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-secondary/60 via-secondary/80 to-accent/60 relative">
    <!-- 暗黑模式切换按钮 -->
    <button 
    ...
    <div class="max-w-md w-full bg-card text-card-foreground p-6 rounded-lg shadow-md transition-colors">
      ...
      <!-- 错误信息 -->
      <div v-if="errorMessage" class="bg-destructive/10 border border-destructive/30 text-destructive px-3 py-2 rounded-md text-sm mb-4">
        {{ errorMessage }}
      </div>
      ...
      <form class="space-y-2" @submit.prevent="onSubmit">
            ...
            <FormControl>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 text-muted-foreground">
          ...
          <FormItem class="mb-1 relative pb-5">
            <FormControl>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 text-muted-foreground">
                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 005 10a6 6 0 0012 0c0-.35-.035-.687-.1-1.016A5 5 0 0010 11z" clip-rule="evenodd" />
                  </svg>
                </div>
                <Input
                  type="text"
        ...
        <div class="pt-3">
          <Button
            type="submit"
            :disabled="isLoading"
            class="w-full flex justify-center py-2 text-sm"
          >
            <span v-if="isLoading" class="mr-2">
              <!-- 简单的加载指示器 -->
              <svg class="animate-spin -ml-1 mr-1 h-4 w-4 text-primary-foreground" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
